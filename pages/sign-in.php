              ...
              <div class="card-body">
                ...
                <form role="form" class="" method="post" action="process.php">
                 <div class="form-group my-3">
                    ...
                    <input type="text" class="form-control shadow p-2" required name="server_id">
                  </div>
                  <div class="form-group my-3">
                  ...
                  <div class="form-check form-switch d-flex align-items-center mb-3">
                    ...
                    <label class="form-check-label mb-0 ms-3" for="rememberMe">Remember me</label><br>
    
                  </div>
                  <p><a href="pass_recovery.php">Forgot Password ?</a></p>
                  <div class="text-center">
                    <input type="submit" class="btn bg-gradient-warning w-100 my-4 mb-2" name="signin" value="Sign In"/>
                  </div>
