                                        ...
                                        <div class="row d_flex">
                                            ...
                                            <div class="col-md-6">
                                                <div class="bluid">
                                                    ...
                                                    <a class="read_more" href="./pages/sign-in.php">Login</a>
                                                    <a class="read_more" href="./pages/sign-up.php">Create an account</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div id="wa_hover" class="wallet_box text_align_center">
                        ...
                        <h3>ACCURATE SECURITY SYSTEM</h3>
                        <p>We provide our investors with the best security to protect their account and crypto from hackers</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="about_text">
                                    <p>Bcryptcoin was founded in 2014 with a clear vision: to make mining simple, friendly, and accessible to everyone.

                                        We provide an open platform where you can mine and earn Bitcoin. Bcryptcoin is also one of the safest crypto companies in the world and is an industry leader in security innovation for mining. </p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="about_img">
                        ...
                        <div class="tab-pane fade show active padi" id="tab1" role="tabpanel" aria-labelledby="home-tab-md">
                            <div class="graf_bootom">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="growth text_align_center">
                                            <h3>Live Mining <span style="color: #face34;" class="pa_ri">USD</span></h3>
        ...
        <div class="footer">
            ...
            <div class="copyright text_align_center ">
               <div class="container ">
                  <div class="row ">
                     <div class="col-md-12 ">
                        <p>© 2022 All Rights Reserved. Design by   <a href="#"> Bcryotcoin</a></p>
                     </div>
                  </div>
               </div>
            </div>
